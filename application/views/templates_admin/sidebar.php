    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('admin/dashboard_admin') ?>">
                ...
                <div class="sidebar-brand-text mx-3">ADMIN JAYA TECH</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin/laporan/bulanan') ?>">
                    <i class="fas fa-fw fa-file-alt"></i> <span>LAPORAN BULANAN</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin/akun') ?>">
                    <i class="fa fa-regular fa-database"></i>
                    <span>DAFTAR AKUN & GANTI PASSWORD</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin/invoice') ?>">
                    ...
                    <span>INVOICES & UPDATE STATUS PEMBAYARAN</span></a>
            </li>
