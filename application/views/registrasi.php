<body class="bg-gradient-white">
    ...
    <div class="container mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg col-lg-6 my-5 mx-auto mt-5">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <div class="form-group mt-3">
                                <p class="text-center" >Sudah Punya Akun? <a href="<?php echo base_url('auth/login') ?>">Login Di Sini</a></p>
                            </div>
                        </div>
                    </div>
                </div>
